...
public class TabFragment2 extends Fragment {
    ...
    JsonObjectRequest weatherObjRequest;
    RequestQueue queue;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        iconImage = (ImageView) getActivity().findViewById(R.id.imageView2);
        cityLists = (ListView) getActivity().findViewById(R.id.listView2);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        weatherObjRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            @Override
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    cityLists.setAdapter(new CustomAdapter(getContext(), time, description, temperature, image));
