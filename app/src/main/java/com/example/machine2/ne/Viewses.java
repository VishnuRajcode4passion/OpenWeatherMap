...
/**
 * Created by machine2 on 15/04/16.
 */
 ...
 */
public class Viewses extends Activity {
...
//       data =bundle.getString("cursor");
//        System.out.println("data"+data);

        SQLController sqlController = new SQLController(Viewses.this);
        sqlController.open();
        // final ArrayList cursor = sqlController.fetch();
        final String cursor = sqlController.fetch();
        System.out.println("cursor" + cursor);
        url = "http://api.openweathermap.org/data/2.5/group?id=" + cursor + "&units=metric&cnt=7&APPID=45df4fca7d202600be0e657e2d0a9dcd";
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        City[i] = jsonObject.getString("name");
                    ...
                    lv.setAdapter(new CityListAdapter(getApplication(), City, temperature, image));
